...
/* ================= TUNING PARAMETERS ================= */
#define COLOR_R_GAIN 1.8f /* Boost red   – TCS3200 less sensitive to red   */
#define COLOR_G_GAIN 2.9f
#define COLOR_B_GAIN 1.99f
#define COLOR_DIFF 110  /* General threshold for R and G detection        */
#define COLOR_B_DIFF 70 /* Lower threshold for B – blue channel is weaker */
